...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tns="urn:librarysample.services.apigee.com" version="1.0">
		...
		<soapenv:Envelope>
			...
			<soapenv:Body>
				<xsl:choose>
					...
					<xsl:when test="not(normalize-space(/addBook))">
						<tns:addBook>
							<xsl:apply-templates select="node()|@*"/>
						</tns:addBook>
					</xsl:when>
